# -*- coding: utf-8 -*-
"""
Created on Mon Oct  3 21:26:32 2016
...
os.chdir(r'C:\Users\thasegawa\Documents\Vehicle Counting')
...
if CAPTURE_FROM_VIDEO:
    IMAGE_SOURCE = "2016-10-05-2126-40.mp4" # Video file
else:
...
def process_frame(frame_number, frame, bg_subtractor, car_counter):
    ...
    #print(DIVIDER_COLOUR)
    #print((0, car_counter.divider))
    ...
    fg_mask = bg_subtractor.apply(frame, None, 0.1)
...
def main():
    ...
    while True:
        ...
        if car_counter is None:
            ...
            car_counter = VehicleCounter(frame.shape[:2], frame.shape[0] * 0.9)
